    ...
    public partial class Customer : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "insert into CustTbl values(" + IdTb.Text + ",'" + NameTb.Text + "','" + AddressTb.Text + "','" + PhoneTb.Text + "')";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "delete from CustTbl where CustId=" + IdTb.Text + ";";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Con.Open();
                    string query = "update CustTbl set CustName ='" + NameTb.Text + "',CustAdd ='" + AddressTb.Text + "', Phone = '" + PhoneTb.Text + "' where CustId =" + IdTb.Text + ";";
                    SqlCommand cmd = new SqlCommand(query, Con);
                    cmd.ExecuteNonQuery();
